...
<section class="terms_conditons">
    <div class="container">
        <div class="content-wrap">
            ...
            <p><b>Affiliate</b> means an entity that controls, is controlled by or is under common control with a
                party,
                where "control" means ownership of 50% or more of the shares, equity interest or other securities
                entitled to vote for election of directors or other managing authority.
            </p>
            <p><b>Country</b> refers to: Ontario, Canada</p>
            <p><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to
                Hocki Draft.</p>
            <p><b>Device</b> means any device that can access the Service such as a computer, a cellphone or a
                digital tablet.</p>
            <p><b>Service</b> refers to the Website.</p>
            <p><b>Terms and Conditions</b> (also referred as "Terms") mean these Terms and Conditions that form the
                entire
                agreement between You and the Company regarding the use of the Service. This Terms and Conditions
                agreement has been created with the help of the Terms and Conditions Generator.</p>
            <p><b>Third-party Social Media Service</b>Third-party Social Media Service means any services or content
                (including data, information, products
                or services) provided by a third-party that may be displayed, included or made available by the
                Service.
            </p>
            <p><b>Website</b>refers to Hocki Draft, accessible from <a href="/">http://hockidraft.com</a></p>
            <p><b>You</b> means the individual accessing or using the Service, or the company, or other legal entity
                on
            ...
            <p>Without limiting the foregoing, neither the Company nor any of the company's provider makes any
                representation or warranty of any kind, express or implied:</p>
            <ol type="a">
                <li>as to the operation or availability of the Service, or the information, content, and
                    materials or products included thereon</li>
                <li>that the Service will be uninterrupted or error-free</li>
                <li>as to the accuracy, reliability, or currency of any information or content provided through the
                    Service</li>
                <li>that the Service, its servers, the content, or e-mails sent from or on behalf of the Company are
                    free of viruses, scripts, trojan horses, worms, malware, timebombs or other harmful components.
                </li>
                <li>Some jurisdictions do not allow the exclusion of certain types of warranties or limitations on
                    ...
                    this section shall be applied to the greatest extent enforceable under applicable law.</li>
            </ol>
            <h3>Governing Law</h3>
            ...
            <p>You are not located in a country that is subject to the United States government embargo, or that has
                been designated by the United States government as a "terrorist supporting" country, and</p>
            <p>You are not listed on any United States government list of prohibited or restricted parties.
            </p>
            ...
            <h3>Contact Us</h3>
            <p><b>If you have any questions about these Terms and Conditions, You can contact us:</b></p>
            <p>By email:<a href="mailto:info@hockidraft.com">info@hockidraft.com</a></p>
        </div>
    </div>
</section>
