      ...
      <div class="row">
        <div class="col-md-8">
          <ul class="list-inline custom-breadcrumb mb-2">
            ...
            <li class="list-inline-item text-white h3 font-secondary nasted">Privacy Policy
            </li>
          </ul>
        </div>
      </div>
  ...
  <section class="privacy-policy">
    <div class="container">
      <div class="content-wrap">
        <h3>Last updated: September 10, 2024</h3>
        ...
        <p>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Hocki
          Draft.</p>
        ...
        <p>Website refers to Hocki Draft, accessible from <a href="http://hockidraft.com">http://hockidraft.com</a></p>
        ...
        <p><b>Purpose:</b>These Cookies are essential to provide You with services available through the Website
          ...
          be provided, and We only use these Cookies to provide You with those services.</p>
        ...
        <p><b>Type:</b>Persistent Cookies</p>
        <p><b>Administered by:</b> Us</p>
        <p><b>Purpose:</b>These Cookies allow us to remember choices You make when You use the Website, such as
        ...
        <p><b>The Company may use Personal Data for the following purposes:</b></p>
        ...
        <p>With Your consent: We may disclose Your personal information for any other purpose with Your consent.
        </p>
        ...
        <p><b>Delete Your Personal Data</b></p>
        ...
        <p><b>The Company may disclose Your Personal Data in the good faith belief that such action is necessary
            to:</b></p>
        <ul>
