   ...
   <div class="container">
       <div class="leagure_container">
           ...
           <div class="flex flex-col items-center justify-center w-screen min-h-screen bg-gray-900 py-10">
               <a href="{{ route('matche-detail',['matcheId'=>$myTeam[0]['dbMatchId']]) }}" class="back-btn"><svg xmlns="http://www.w3.org/2000/svg"
               ...
               <div class="flex flex-col mt-6">
                   <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                       <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                               ...
                               <div class="div-tbl">
                                   <table class="table table-light table-striped table-hover table-sm">
                                       ...
                                       <tbody>
                                           ...
                                           {{-- <tr>
                                               <td class="player-dp">
                                                   <img src="images/word_one.avif" alt="dp">
                                               </td>
                                               <td>
                                                   <h6>J Broun</h6>
                                                   <span>34 pts</span>
                           ...
                           <div class="team-btns">
                               {{-- <a href="team-view" class="next-btn">save</a> --}}
